...
export default function Rates({ lang = 'si' }: { lang?: 'si' | 'en' | 'ta' }) {
  ...
  return (
    <div className="py-24 bg-[#f8fafc] dark:bg-[#020617] min-h-screen transition-colors duration-500 relative overflow-hidden">
      ...
      {/* --- PREMIUM DECORATIVE ELEMENTS (Both Modes) --- */}
      {/* Top Left Glow */}
      ...
      {/* Modern Grid Pattern (Light mode ekata lassanai) */}
      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        ...
        <div className="text-center mb-20">
          ...
          >
            <TrendingUp size={14} /> Market Leading Rates 2024
          </motion.div>
          <motion.h1 
            initial={{ opacity: 0, scale: 0.95 }}
            animate={{ opacity: 1, scale: 1 }}
            className="text-6xl md:text-7xl font-black text-slate-900 dark:text-white mb-6 tracking-tighter italic uppercase"
          >
            ...
            {fdRates.map((rate, idx) => (
              ...
              >
                ...
                <div className="text-center">
                  ...
                  <h3 className={`text-3xl font-black italic uppercase tracking-tighter mb-8 ${rate.is_popular ? 'text-white' : 'text-slate-800 dark:text-white'}`}>
                    {rate.period}
                  </h3>
        ...
        <div className="grid lg:grid-cols-2 gap-8 mb-24">
          ...
          >
              ...
              <h2 className="text-4xl font-black italic uppercase tracking-tighter mb-10 relative z-10 leading-[0.9]">
              ...
              <div className="grid sm:grid-cols-2 gap-8 relative z-10">
                {t.features.map((f, i) => (
                  <div key={i} className="group">
                    ...
                    <h4 className="font-black uppercase italic tracking-widest text-xs mb-2">{f.t}</h4>
          ...
          >
              <div className="flex items-start gap-6 mb-12">
                ...
                <div>
                  <h3 className="text-2xl font-black italic uppercase text-slate-800 dark:text-white tracking-tighter mb-2">Ready to start?</h3>
