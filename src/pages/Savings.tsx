...
import { PiggyBank, Loader2, ShieldCheck, ArrowRight, Zap, Gift, Coins, TrendingUp } from 'lucide-react';
      ...
      <section className="relative pt-32 pb-20 px-6 overflow-hidden">
        <div className="max-w-7xl mx-auto flex flex-col items-center text-center relative z-10">
          <motion.div 
            ...
            className="flex items-center gap-2 px-5 py-2 rounded-full bg-blue-50 text-blue-700 dark:bg-blue-500/10 dark:text-blue-400 border border-blue-200 dark:border-blue-500/20 text-[10px] font-black uppercase tracking-[0.3em] mb-10"
          >
        ...
        <div className="absolute top-0 left-1/2 -translate-x-1/2 w-full h-[500px] bg-blue-500/[0.04] dark:bg-blue-500/5 blur-[120px] rounded-full -z-0" />
      </section>
              ...
              >
                ...
                <div className="absolute top-8 right-8 z-20">
                  <div className="bg-white dark:bg-slate-900 shadow-xl px-4 py-2 rounded-2xl border border-slate-100 dark:border-white/10">
                    ...
                    <p className="text-xl font-black text-blue-600 italic leading-none">{savings.interest}</p>
                  </div>
                </div>
        ...
        <div className="mt-32 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          {t.info.map((item, i) => (
            <motion.div 
              key={i}
              whileHover={{ y: -10 }}
              className="p-10 rounded-[3rem] bg-slate-900 dark:bg-slate-950 text-white relative overflow-hidden group transition-all shadow-2xl"
            >
